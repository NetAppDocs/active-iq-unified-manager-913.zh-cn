...
此外，在安装第二个 Unified Manager 实例之前，单个 Unified Manager 实例可以监视的节点数有限制。有关详细信息，请参见 link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf["《 Unified Manager 最佳实践指南》"^]。
