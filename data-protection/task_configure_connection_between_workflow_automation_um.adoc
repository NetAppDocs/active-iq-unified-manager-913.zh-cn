...
[NOTE]
====
"用于管理 Clustered Data ONTAP 的 WFA pack"包含在 WFA 5.1 中，因此无需像过去要求的那样从 NetAppStorage Automation Store 下载此包并将其单独安装到 WFA 服务器上。 https://mysupport.netapp.com/site/products/all/details/ocwfa/downloads-tab["WFA 下载"^]
