...
* Red Hat Enterprise Linux 7.x版以及8.0到8.7版、基于x86_64架构。
...
* MySQL Community Edition 8.0.32版(来自MySQL存储库)。
* OpenJDK 11.0.18版(来自Red Hat Extra Enterprise Linux Server存储库)
* Python 3.6.x
